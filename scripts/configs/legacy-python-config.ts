...
export const collectors: Record<string, PythonCollectorConfig> = {
    ...
    'cni-indicators': { name: 'cni-indicators', description: 'CNI Industry Indicators', script: 'scripts/collect-cni-indicators.py', schedule: '0 9 5 * *', category: 'economic' },
    ...
    'fiesp-data': { name: 'fiesp-data', description: 'FIESP Industry Indicators (Sensor + INA)', script: 'scripts/collect-fiesp-data.py', schedule: '0 9 1 * *', category: 'economic' },
    ...
    'infojobs-brasil': { name: 'infojobs-brasil', description: 'InfoJobs Brasil Web Scraper', script: 'scripts/collect-infojobs-brasil.py', schedule: '0 */6 * * *', category: 'economic' },
