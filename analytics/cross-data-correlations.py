...
def main():
    ...
    # 5. Health vs Economic Productivity (using socioeconomic_indicators life expectancy)
    ...
    try:
        cur.execute("""
            ...
            GROUP BY country_name
            HAVING MAX(CASE WHEN indicator_code = 'SP.DYN.LE00.IN' THEN value END) IS NOT NULL
