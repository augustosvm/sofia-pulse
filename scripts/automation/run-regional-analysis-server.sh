#!/bin/bash
# ============================================================================
# Sofia Pulse - Análise Regional de Papers (Executar no Servidor)
# ============================================================================
#
# Este script executa as queries SQL de análise regional diretamente no servidor.
# Execute via SSH: ssh ubuntu@91.98.158.19 'bash -s' < run-regional-analysis-server.sh
#
# Ou copie para o servidor e execute lá:
# scp run-regional-analysis-server.sh ubuntu@91.98.158.19:/tmp/
# ssh ubuntu@91.98.158.19 'bash /tmp/run-regional-analysis-server.sh'
# ============================================================================
...
if [ -f /home/ubuntu/sofia-pulse/.env ]; then
    source /home/ubuntu/sofia-pulse/.env
elif [ -f .env ]; then
    source .env
fi
