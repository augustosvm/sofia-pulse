#!/usr/bin/env python3
"""Restore trends data robustly handling schema"""
...
print("=" * 80)
print("♻️ RESTORING TRENDS (ROBUST)")
print("=" * 80)
print()
...
name_col = 'name' if 'name' in cols else 'trend_name'
...
for name, meta in trends_found.items():
    try:
        ...
        # Ensure we don't insert NULL for normalized_name
