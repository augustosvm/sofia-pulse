...
echo "────────────────────────────────────────────────────────────────"
echo "🌍 [3/6] Remotive (Remote-first)"
echo "────────────────────────────────────────────────────────────────"
...
# 4. WeWorkRemotely
echo "────────────────────────────────────────────────────────────────"
echo "💼 [4/6] WeWorkRemotely"
echo "────────────────────────────────────────────────────────────────"
if npx tsx scripts/collect-jobs-weworkremotely.ts; then
    echo "✅ WeWorkRemotely completed"
else
    echo "⚠️  WeWorkRemotely failed"
fi
echo ""

# 5. Himalayas
echo "────────────────────────────────────────────────────────────────"
echo "🏔️ [5/6] Himalayas"
echo "────────────────────────────────────────────────────────────────"
if npx tsx scripts/collect-jobs-himalayas.ts; then
    echo "✅ Himalayas completed"
else
    echo "⚠️  Himalayas failed"
fi
echo ""

# 6. GitHub Jobs (if exists)
echo "────────────────────────────────────────────────────────────────"
