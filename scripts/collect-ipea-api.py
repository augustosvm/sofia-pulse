...
IPEA_SERIES = {
    "PRECOS12_IPCAG12": {"name": "IPC-A Geral - Inflação", "category": "inflation", "source": "IBGE"},
    "PAN12_PIBPMV12": {"name": "PIB mensal - Valores correntes", "category": "gdp", "source": "IBGE"},
    "ESTIMA12_TJOVER12": {"name": "Taxa de juros - Over/Selic", "category": "interest_rate", "source": "BACEN"},
    "PAN12_PIBAGRO12": {"name": "PIB Agropecuária", "category": "sector_gdp", "source": "IBGE"},
    "PAN12_PIBIND12": {"name": "PIB Indústria", "category": "sector_gdp", "source": "IBGE"},
    "PAN12_PIBSERV12": {"name": "PIB Serviços", "category": "sector_gdp", "source": "IBGE"},
    "BM12_SALMIN12": {"name": "Salário mínimo", "category": "income", "source": "IPEA"},
    "PNADC12_TDESOC12": {"name": "Taxa de desocupação", "category": "employment", "source": "IBGE"},
    "PNADC12_RRTH12": {"name": "Rendimento real médio habitual", "category": "income", "source": "IBGE"},
    "GAC12_FBCFN12": {"name": "Formação bruta de capital fixo", "category": "investment", "source": "IBGE"},
}
