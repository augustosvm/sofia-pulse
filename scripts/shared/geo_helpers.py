...
COUNTRY_ALIASES = {
    ...
    'argentina': 'Argentina', 'chile': 'Chile', 'colômbia': 'Colombia', 'colombia': 'Colombia',
    'peru': 'Peru', 'venezuela': 'Venezuela', 'equador': 'Ecuador', 'bolívia': 'Bolivia', 'bolivia': 'Bolivia',
    'paraguai': 'Paraguay', 'uruguai': 'Uruguay', 'guiana': 'Guyana', 'suriname': 'Suriname',
    'guiana francesa': 'French Guiana', 'costa rica': 'Costa Rica', 'panamá': 'Panama', 'panama': 'Panama',
    'guatemala': 'Guatemala', 'belize': 'Belize', 'honduras': 'Honduras', 'el salvador': 'El Salvador',
    'nicarágua': 'Nicaragua', 'nicaragua': 'Nicaragua',
    'cuba': 'Cuba', 'jamaica': 'Jamaica', 'haiti': 'Haiti', 'república dominicana': 'Dominican Republic',
    'republica dominicana': 'Dominican Republic', 'porto rico': 'Puerto Rico',
    'bahamas': 'Bahamas', 'barbados': 'Barbados', 'trinidad e tobago': 'Trinidad and Tobago',
    'granada': 'Grenada', 'santa lúcia': 'Saint Lucia', 'santa lucia': 'Saint Lucia',
    'são vicente e granadinas': 'Saint Vincent and the Grenadines',
    'antígua e barbuda': 'Antigua and Barbuda', 'dominica': 'Dominica',
    'são cristóvão e nevis': 'Saint Kitts and Nevis',

    # Europe
    'alemanha': 'Germany', 'frança': 'France', 'franca': 'France', 'reino unido': 'United Kingdom',
    'itália': 'Italy', 'italia': 'Italy', 'espanha': 'Spain', 'portugal': 'Portugal',
    'países baixos': 'Netherlands', 'paises baixos': 'Netherlands', 'holanda': 'Netherlands',
    'países baixos (holanda)': 'Netherlands',
    'bélgica': 'Belgium', 'belgica': 'Belgium', 'suíça': 'Switzerland', 'suica': 'Switzerland',
    'áustria': 'Austria', 'austria': 'Austria', 'suécia': 'Sweden', 'suecia': 'Sweden',
    'noruega': 'Norway', 'dinamarca': 'Denmark', 'finlândia': 'Finland', 'finlandia': 'Finland',
    'islândia': 'Iceland', 'islandia': 'Iceland', 'irlanda': 'Ireland',
    'polônia': 'Poland', 'polonia': 'Poland', 'república tcheca': 'Czech Republic', 'republica tcheca': 'Czech Republic',
    'tchéquia': 'Czechia', 'tchequia': 'Czechia',
    'eslováquia': 'Slovakia', 'eslovaquia': 'Slovakia', 'hungria': 'Hungary',
    'romênia': 'Romania', 'romenia': 'Romania', 'bulgária': 'Bulgaria', 'bulgaria': 'Bulgaria',
    'grécia': 'Greece', 'grecia': 'Greece', 'croácia': 'Croatia', 'croacia': 'Croatia',
    'sérvia': 'Serbia', 'serbia': 'Serbia', 'bósnia e herzegovina': 'Bosnia and Herzegovina',
    'bosnia e herzegovina': 'Bosnia and Herzegovina', 'montenegro': 'Montenegro',
    'macedônia do norte': 'North Macedonia', 'macedonia do norte': 'North Macedonia',
    'albânia': 'Albania', 'albania': 'Albania', 'eslovênia': 'Slovenia', 'eslovenia': 'Slovenia',
    'estônia': 'Estonia', 'estonia': 'Estonia', 'letônia': 'Latvia', 'letonia': 'Latvia',
    'lituânia': 'Lithuania', 'lituania': 'Lithuania',
    'ucrânia': 'Ukraine', 'ucrania': 'Ukraine', 'bielorrússia': 'Belarus', 'bielorrussia': 'Belarus',
    'rússia': 'Russia', 'russia': 'Russia', 'moldávia': 'Moldova', 'moldavia': 'Moldova',
    'luxemburgo': 'Luxembourg', 'mônaco': 'Monaco', 'monaco': 'Monaco',
    'liechtenstein': 'Liechtenstein', 'andorra': 'Andorra', 'san marino': 'San Marino',
    'vaticano': 'Vatican City', 'malta': 'Malta', 'chipre': 'Cyprus',

    # Africa
    'áfrica do sul': 'South Africa', 'africa do sul': 'South Africa',
    'egito': 'Egypt', 'líbia': 'Libya', 'libia': 'Libya', 'tunísia': 'Tunisia', 'tunisia': 'Tunisia',
    'argélia': 'Algeria', 'argelia': 'Algeria', 'marrocos': 'Morocco',
    'sudão': 'Sudan', 'sudao': 'Sudan', 'sudão do sul': 'South Sudan', 'sudao do sul': 'South Sudan',
    'etiópia': 'Ethiopia', 'etiopia': 'Ethiopia', 'eritreia': 'Eritrea',
    'somália': 'Somalia', 'somalia': 'Somalia', 'djibuti': 'Djibouti', 'quênia': 'Kenya', 'quenia': 'Kenya',
    'tanzânia': 'Tanzania', 'tanzania': 'Tanzania', 'uganda': 'Uganda', 'ruanda': 'Rwanda',
    'burundi': 'Burundi', 'nigéria': 'Nigeria', 'nigeria': 'Nigeria', 'níger': 'Niger', 'niger': 'Niger',
    'chade': 'Chad', 'mali': 'Mali', 'mauritânia': 'Mauritania', 'mauritania': 'Mauritania',
    'senegal': 'Senegal', 'gâmbia': 'Gambia', 'gambia': 'Gambia',
    'guiné': 'Guinea', 'guine': 'Guinea', 'guiné-bissau': 'Guinea-Bissau', 'guine-bissau': 'Guinea-Bissau',
    'serra leoa': 'Sierra Leone', 'libéria': 'Liberia', 'liberia': 'Liberia',
    'costa do marfim': 'Ivory Coast', 'gana': 'Ghana', 'togo': 'Togo', 'benin': 'Benin',
    'burkina faso': 'Burkina Faso', 'camarões': 'Cameroon', 'camaroes': 'Cameroon',
    'república centro-africana': 'Central African Republic', 'republica centro-africana': 'Central African Republic',
    'gabão': 'Gabon', 'gabao': 'Gabon', 'república do congo': 'Republic of the Congo',
    'republica do congo': 'Republic of the Congo', 'congo': 'Republic of the Congo',
    ...
    'angola': 'Angola', 'zâmbia': 'Zambia', 'zambia': 'Zambia', 'zimbábue': 'Zimbabwe', 'zimbabue': 'Zimbabwe',
    'moçambique': 'Mozambique', 'mocambique': 'Mozambique', 'malawi': 'Malawi', 'madagáscar': 'Madagascar',
    'madagascar': 'Madagascar', 'maurício': 'Mauritius', 'mauricio': 'Mauritius',
    'seicheles': 'Seychelles', 'comores': 'Comoros', 'namíbia': 'Namibia', 'namibia': 'Namibia',
    'botsuana': 'Botswana', 'lesoto': 'Lesotho', 'suazilândia': 'Eswatini', 'suazilandia': 'Eswatini',
    'eswatini': 'Eswatini', 'cabo verde': 'Cape Verde', 'são tomé e príncipe': 'Sao Tome and Principe',
    'sao tome e principe': 'Sao Tome and Principe', 'guiné equatorial': 'Equatorial Guinea',
    'guine equatorial': 'Equatorial Guinea',

    # Asia
    'china': 'China', 'japão': 'Japan', 'japao': 'Japan', 'coreia do sul': 'South Korea',
    'coreia do norte': 'North Korea', 'mongólia': 'Mongolia', 'mongolia': 'Mongolia',
    'índia': 'India', 'india': 'India', 'paquistão': 'Pakistan', 'paquistao': 'Pakistan',
    'bangladesh': 'Bangladesh', 'sri lanka': 'Sri Lanka', 'nepal': 'Nepal', 'butão': 'Bhutan', 'butao': 'Bhutan',
    'maldivas': 'Maldives', 'afeganistão': 'Afghanistan', 'afeganistao': 'Afghanistan',
    'irã': 'Iran', 'ira': 'Iran', 'iraque': 'Iraq', 'síria': 'Syria', 'siria': 'Syria',
    'líbano': 'Lebanon', 'libano': 'Lebanon', 'jordânia': 'Jordan', 'jordania': 'Jordan',
    'israel': 'Israel', 'palestina': 'Palestine', 'arábia saudita': 'Saudi Arabia',
    'arabia saudita': 'Saudi Arabia', 'iêmen': 'Yemen', 'iemen': 'Yemen',
    'omã': 'Oman', 'oma': 'Oman', 'emirados árabes unidos': 'United Arab Emirates',
    'emirados arabes unidos': 'United Arab Emirates',
    'catar': 'Qatar', 'bahrein': 'Bahrain', 'kuwait': 'Kuwait',
    'turquia': 'Turkey', 'armênia': 'Armenia', 'armenia': 'Armenia',
    'azerbaijão': 'Azerbaijan', 'azerbaijao': 'Azerbaijan', 'geórgia': 'Georgia', 'georgia': 'Georgia',
    'cazaquistão': 'Kazakhstan', 'cazaquistao': 'Kazakhstan', 'uzbequistão': 'Uzbekistan',
    'uzbequistao': 'Uzbekistan', 'turcomenistão': 'Turkmenistan', 'turcomenistao': 'Turkmenistan',
    'quirguistão': 'Kyrgyzstan', 'quirguistao': 'Kyrgyzstan', 'tadjiquistão': 'Tajikistan',
    'tadjiquistao': 'Tajikistan',
    'tailândia': 'Thailand', 'tailandia': 'Thailand', 'vietnã': 'Vietnam', 'vietna': 'Vietnam',
    'mianmar': 'Myanmar', 'laos': 'Laos', 'camboja': 'Cambodia',
    'malásia': 'Malaysia', 'malasia': 'Malaysia', 'singapura': 'Singapore',
    'indonésia': 'Indonesia', 'indonesia': 'Indonesia', 'filipinas': 'Philippines',
    'brunei': 'Brunei', 'timor-leste': 'Timor-Leste', 'hong kong': 'Hong Kong',
    'macau': 'Macau', 'taiwan': 'Taiwan', 'taiwan (formosa)': 'Taiwan',

    # Oceania
    'austrália': 'Australia', 'australia': 'Australia', 'nova zelândia': 'New Zealand',
    'nova zelandia': 'New Zealand', 'papua nova guiné': 'Papua New Guinea',
    'papua nova guine': 'Papua New Guinea', 'fiji': 'Fiji', 'ilhas salomão': 'Solomon Islands',
    'ilhas salomao': 'Solomon Islands', 'vanuatu': 'Vanuatu', 'samoa': 'Samoa',
    'tonga': 'Tonga', 'micronésia': 'Micronesia', 'micronesia': 'Micronesia',
    'palau': 'Palau', 'kiribati': 'Kiribati', 'tuvalu': 'Tuvalu', 'nauru': 'Nauru',
    ...
    'ph': 'Philippines', 'tr': 'Turkey', 'eg': 'Egypt', 'ng': 'Nigeria',
    'ke': 'Kenya', 'tz': 'Tanzania', 'ma': 'Morocco', 'dz': 'Algeria',
    'ru': 'Russia', 'ua': 'Ukraine', 'no': 'Norway', 'se': 'Sweden',
    'dk': 'Denmark', 'fi': 'Finland', 'gr': 'Greece', 'pt': 'Portugal',
}
