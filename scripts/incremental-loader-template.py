...
class GitHubTrendingLoader(IncrementalLoader):
    ...
    def __init__(self):
        ...
        self.headers = {"Accept": "application/vnd.github+json", "User-Agent": "Sofia-Pulse-Collector"}
...
def main():
    ...
    parser.add_argument(
        "source", choices=["github", "hn", "reddit", "npm", "pypi", "gdelt"], help="Data source to collect"
    )
