...
echo "════════════════════════════════════════════════════════════════"
echo "📅 INSTALLING COMPLETE CRONTAB (62 COLLECTORS)"
echo "════════════════════════════════════════════════════════════════"
echo ""
...
# Create complete crontab
cat > /tmp/sofia-crontab-complete-with-jobs.txt << EOF
# ============================================================================
# SOFIA PULSE - COMPLETE SCHEDULE (62 COLLECTORS)
# ============================================================================
# Strategy:
...
# - Job collectors: 3x per day (morning, afternoon, evening)
...
# ============================================================================
# 13:00 UTC (10:00 BRT) - INTERNATIONAL ORGANIZATIONS (Part 2) + JOB COLLECTORS (1st run)
# ============================================================================
...
# JOB COLLECTORS - Morning Run (10:00 BRT)
50 13 * * 1-5 cd \$SOFIA_DIR && source venv/bin/activate && python3 scripts/collect-rapidapi-activejobs.py >> /var/log/sofia/jobs-activejobs.log 2>&1
55 13 * * 1-5 cd \$SOFIA_DIR && source venv/bin/activate && python3 scripts/collect-careerjet-api.py >> /var/log/sofia/jobs-careerjet.log 2>&1

# ============================================================================
# 14:00 UTC (11:00 BRT) - WOMEN & GENDER DATA + JOB COLLECTORS (continued)
# ============================================================================
...
# JOB COLLECTORS - Morning Run (continued)
55 14 * * 1-5 cd \$SOFIA_DIR && source venv/bin/activate && python3 scripts/collect-himalayas-api.py >> /var/log/sofia/jobs-himalayas.log 2>&1

# ============================================================================
# 15:00 UTC (12:00 BRT) - SOCIAL & DEMOGRAPHICS + JOB COLLECTORS (continued)
# ============================================================================
...
# JOB COLLECTORS - Morning Run (continued)
50 15 * * 1-5 cd \$SOFIA_DIR && source venv/bin/activate && python3 scripts/collect-freejobs-api.py >> /var/log/sofia/jobs-freejobs.log 2>&1
...
# ============================================================================
# 18:00 UTC (15:00 BRT) - BRAZIL SECURITY & MINISTRIES + JOB COLLECTORS (2nd run - Afternoon)
# ============================================================================
...
# JOB COLLECTORS - Afternoon Run (15:00 BRT)
30 18 * * 1-5 cd \$SOFIA_DIR && source venv/bin/activate && python3 scripts/collect-rapidapi-activejobs.py >> /var/log/sofia/jobs-activejobs-2.log 2>&1
35 18 * * 1-5 cd \$SOFIA_DIR && source venv/bin/activate && python3 scripts/collect-careerjet-api.py >> /var/log/sofia/jobs-careerjet-2.log 2>&1
40 18 * * 1-5 cd \$SOFIA_DIR && source venv/bin/activate && python3 scripts/collect-himalayas-api.py >> /var/log/sofia/jobs-himalayas-2.log 2>&1
45 18 * * 1-5 cd \$SOFIA_DIR && source venv/bin/activate && python3 scripts/collect-freejobs-api.py >> /var/log/sofia/jobs-freejobs-2.log 2>&1
...
# ============================================================================
# 21:00 UTC (18:00 BRT) - SPECIALIZED DATA + JOB COLLECTORS (3rd run - Evening)
# ============================================================================
...
# JOB COLLECTORS - Evening Run (18:00 BRT)
...
echo "════════════════════════════════════════════════════════════════"
echo "📄 NEW COMPLETE CRONTAB (62 COLLECTORS)"
echo "════════════════════════════════════════════════════════════════"
cat /tmp/sofia-crontab-complete-with-jobs.txt
echo ""
echo "════════════════════════════════════════════════════════════════"
echo ""

# Apply crontab
crontab /tmp/sofia-crontab-complete-with-jobs.txt

echo "✅ Complete crontab installed successfully!"
echo ""
echo "📊 COLLECTORS SCHEDULED:"
echo "   • 55 Data collectors (analytics, research, government, etc.)"
echo "   • 7 Job collectors (RapidAPI, LinkedIn, Google Jobs, etc.)"
echo "   • TOTAL: 62 collectors"
echo ""
echo "📅 JOB COLLECTORS SCHEDULE:"
echo "   • 10:00 BRT (13:50 UTC) - Morning run (4 collectors)"
echo "   • 15:00 BRT (18:30 UTC) - Afternoon run (4 collectors)"
echo "   • 18:00 BRT (21:50 UTC) - Evening run (7 collectors - ALL)"
echo ""
echo "📅 DATA COLLECTORS DISTRIBUTION:"
...
echo ""
echo "📝 VERIFY:"
echo "   crontab -l | grep -c 'collect-' # Should show 62+"
echo "   crontab -l | grep 'jobs-'"
echo ""
