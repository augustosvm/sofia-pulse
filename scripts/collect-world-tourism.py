...
TOURISM_INDICATORS = {
    ...
    # ===========================================
    "ST.INT.ARVL": {"name": "International tourism, number of arrivals", "category": "arrivals", "unit": "number"},
    "ST.INT.DPRT": {"name": "International tourism, number of departures", "category": "departures", "unit": "number"},
    "ST.INT.RCPT.CD": {
...
def fetch_tourism_data(indicator_code: str) -> List[Dict]:
    ...
    params = {"format": "json", "per_page": 10000, "date": "2000:2024", "source": 2}
...
def fetch_regional_aggregates() -> List[Dict]:
    ...
    for indicator_code in ["ST.INT.ARVL", "ST.INT.RCPT.CD"]:
        ...
        params = {"format": "json", "per_page": 500, "date": "2000:2024"}
