...
class CollectorReporter:
    ...
    def report_progress(self, message: str, current: Optional[int] = None, total: Optional[int] = None) -> None:
...
def report_collector_success(collector_name: str, collected: int, errors: int = 0) -> None:
...
def report_collector_failure(collector_name: str, error: Exception | str) -> None:
