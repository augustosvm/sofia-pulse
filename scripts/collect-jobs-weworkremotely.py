#!/usr/bin/env python3
"""
Wrapper for collect-jobs-weworkremotely.ts
...
def main():
    ...
    ts_script = script_dir / "collect-jobs-weworkremotely.ts"

    if not ts_script.exists():
        print(f"❌ ERROR: SCRIPT_NOT_FOUND - collect-jobs-weworkremotely.ts")
        sys.exit(1)
