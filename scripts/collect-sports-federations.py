...
FEDERATIONS_DATA = {
    ...
    "UEFA": {
        ...
        "club_rankings": [
            ...
            ("PSG", "FRA", 5),
            ("Inter Milan", "ITA", 6),
            ("Borussia Dortmund", "DEU", 7),
            ("Barcelona", "ESP", 8),
            ("Atletico Madrid", "ESP", 9),
            ("Bayer Leverkusen", "DEU", 10),
        ],
    ...
    "FIA": {
        ...
        "f1_2024": [
            ...
            ("Lando Norris", "GBR", 2),
            ("Charles Leclerc", "MCO", 3),
            ("Oscar Piastri", "AUS", 4),
            ("Carlos Sainz", "ESP", 5),
            ("Lewis Hamilton", "GBR", 6),
            ("George Russell", "GBR", 7),
            ("Sergio Perez", "MEX", 8),
        ],
    },
    # ===========================================
        ...
        try:
            ...
            """,
                (
                    ...
                    headquarters,
                    fed_data.get(
                        "member_associations", fed_data.get("member_federations", fed_data.get("member_countries", 0))
                    ),
                ...
                for ranking in rankings:
                    try:
                        if len(ranking) == 3:  # (country_code, country_name, rank)
                            ...
                            """,
                                (fed_code, ranking_type, sex, ranking[2], ranking[0], ranking[1], ranking[1], 2024),
                            )
                            inserted += 1
                    except:
                        continue
