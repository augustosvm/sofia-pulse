...
ALL_COUNTRIES = {
    # Europe (all)
    'europe': [
        'DEU', 'FRA', 'GBR', 'ITA', 'ESP', 'POL', 'NLD', 'BEL', 'CZE', 'GRC',
        'PRT', 'SWE', 'HUN', 'AUT', 'CHE', 'BGR', 'DNK', 'FIN', 'SVK', 'NOR',
        'IRL', 'HRV', 'LTU', 'SVN', 'LVA', 'EST', 'CYP', 'LUX', 'MLT', 'ISL',
        'SRB', 'BIH', 'ALB', 'MKD', 'MNE', 'ROU', 'UKR', 'BLR', 'MDA', 'RUS',
    ],
    # Americas
    'americas': [
        'USA', 'CAN', 'MEX', 'BRA', 'ARG', 'COL', 'CHL', 'PER', 'VEN', 'ECU',
        'BOL', 'PRY', 'URY', 'CRI', 'PAN', 'GTM', 'HND', 'SLV', 'NIC', 'DOM',
        'CUB', 'JAM', 'HTI', 'TTO', 'BHS', 'BRB', 'GUY', 'SUR',
    ],
    # Asia (top 20+)
    'asia': [
        'CHN', 'JPN', 'IND', 'KOR', 'IDN', 'THA', 'VNM', 'MYS', 'SGP', 'PHL',
        'PAK', 'BGD', 'IRN', 'IRQ', 'SAU', 'ARE', 'ISR', 'TUR', 'AFG', 'MMR',
        'KHM', 'LAO', 'NPL', 'LKA', 'KAZ', 'UZB', 'HKG', 'TWN',
    ],
    # Oceania
    'oceania': [
        'AUS', 'NZL', 'PNG', 'FJI',
    ...
    # Africa (major)
    'africa': [
        'ZAF', 'EGY', 'NGA', 'MAR', 'KEN', 'ETH', 'TZA', 'GHA', 'UGA', 'DZA',
    ],
}
...
UNODC_PREVALENCE_DATA = {
    ...
    'cannabis': [
        # Europe
        ('FRA', 'France', 11.0), ('ITA', 'Italy', 10.2), ('ESP', 'Spain', 10.5),
        ('CZE', 'Czechia', 9.8), ('NLD', 'Netherlands', 8.5), ('DEU', 'Germany', 8.0),
        ('GBR', 'United Kingdom', 7.8), ('DNK', 'Denmark', 7.0), ('IRL', 'Ireland', 6.5),
        ('BEL', 'Belgium', 6.2), ('AUT', 'Austria', 5.8), ('SWE', 'Sweden', 3.5),
        ('POL', 'Poland', 4.2), ('PRT', 'Portugal', 5.5), ('GRC', 'Greece', 4.0),
        ('NOR', 'Norway', 5.0), ('FIN', 'Finland', 4.5), ('HUN', 'Hungary', 3.8),
        # Americas
        ('USA', 'United States', 19.5), ('CAN', 'Canada', 27.0), ('URY', 'Uruguay', 14.5),
        ('CHL', 'Chile', 11.8), ('ARG', 'Argentina', 7.5), ('BRA', 'Brazil', 3.5),
        ('MEX', 'Mexico', 2.1), ('COL', 'Colombia', 4.8), ('JAM', 'Jamaica', 8.5),
        # Asia
        ('ISR', 'Israel', 8.5), ('AUS', 'Australia', 12.0), ('NZL', 'New Zealand', 11.5),
        ('JPN', 'Japan', 1.4), ('KOR', 'South Korea', 0.4), ('SGP', 'Singapore', 0.2),
    ],

    # Cocaine prevalence (% of population 15-64)
    'cocaine': [
        # Europe
        ('GBR', 'United Kingdom', 2.7), ('ESP', 'Spain', 2.4), ('NLD', 'Netherlands', 2.1),
        ('DNK', 'Denmark', 2.0), ('IRL', 'Ireland', 1.9), ('FRA', 'France', 1.6),
        ('DEU', 'Germany', 1.5), ('ITA', 'Italy', 1.3), ('BEL', 'Belgium', 1.2),
        ('PRT', 'Portugal', 0.8), ('AUT', 'Austria', 0.9), ('CHE', 'Switzerland', 1.0),
        # Americas
        ('USA', 'United States', 2.0), ('CAN', 'Canada', 2.5), ('ARG', 'Argentina', 1.5),
        ('CHL', 'Chile', 1.8), ('BRA', 'Brazil', 1.0), ('COL', 'Colombia', 1.2),
        ('URY', 'Uruguay', 1.3), ('MEX', 'Mexico', 0.8),
        # Oceania
        ('AUS', 'Australia', 3.5), ('NZL', 'New Zealand', 1.0),
    ],

    # Opioids prevalence (% of population 15-64)
    'opioids': [
        # Americas
        ('USA', 'United States', 4.0), ('CAN', 'Canada', 3.2),
        # Europe
        ('GBR', 'United Kingdom', 0.8), ('IRL', 'Ireland', 0.9), ('EST', 'Estonia', 1.5),
        ('LVA', 'Latvia', 0.6), ('LTU', 'Lithuania', 0.4),
        # Asia (high burden)
        ('AFG', 'Afghanistan', 3.5), ('IRN', 'Iran', 2.8), ('PAK', 'Pakistan', 0.9),
        ('MMR', 'Myanmar', 0.8), ('IND', 'India', 0.4),
        # Oceania
        ('AUS', 'Australia', 0.9),
    ],
    ...
    'amphetamines': [
        # Europe
        ('FIN', 'Finland', 1.5), ('SWE', 'Sweden', 1.2), ('CZE', 'Czechia', 1.0),
        ('NLD', 'Netherlands', 1.3), ('GBR', 'United Kingdom', 0.8), ('DEU', 'Germany', 0.8),
        # Americas
        ('USA', 'United States', 2.0), ('CAN', 'Canada', 1.0), ('MEX', 'Mexico', 0.5),
        # Asia
        ('THA', 'Thailand', 1.5), ('JPN', 'Japan', 0.5), ('KOR', 'South Korea', 0.3),
        ('PHL', 'Philippines', 2.0), ('IDN', 'Indonesia', 0.3),
        # Oceania
        ('AUS', 'Australia', 1.5), ('NZL', 'New Zealand', 0.8),
    ],

    # Ecstasy/MDMA prevalence (% of population 15-64)
    'ecstasy': [
        # Europe
        ('NLD', 'Netherlands', 2.8), ('IRL', 'Ireland', 2.5), ('GBR', 'United Kingdom', 2.2),
        ('CZE', 'Czechia', 1.5), ('BEL', 'Belgium', 1.0), ('DEU', 'Germany', 0.8),
        ('ESP', 'Spain', 0.9), ('FRA', 'France', 0.7),
        # Americas
        ('USA', 'United States', 0.9), ('CAN', 'Canada', 1.2),
        # Oceania
        ('AUS', 'Australia', 2.5), ('NZL', 'New Zealand', 1.8),
    ],
}
