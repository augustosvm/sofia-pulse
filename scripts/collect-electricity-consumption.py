            ...
            records.append(
                {
                    ...
                    "electricity_demand": (
                        float(row["electricity_demand"]) if pd.notna(row["electricity_demand"]) else None
                    ),
                    "electricity_generation": (
                        float(row.get("electricity_generation", 0))
                        if pd.notna(row.get("electricity_generation"))
                        else None
                    ),
                    "per_capita": (
                        float(row.get("per_capita_electricity", 0))
                        if pd.notna(row.get("per_capita_electricity"))
                        else None
                    ),
